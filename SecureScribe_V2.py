...
# Create a folder if it doesn't exist for logging
log_folder = "ScribeLogs"
os.makedirs(log_folder, exist_ok=True)

# Configure logging
log_file = os.path.join(log_folder, "securescribe.log")
